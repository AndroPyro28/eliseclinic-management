  ...
  return (
    <>
      <PageHeader
        ...
        title={`${ENTITY_NAME} # ${currentErp.salesInvoiceNumber}/${currentErp.year || ''}`}
        ghost={false}
      ...
      <Divider dashed />
      <Descriptions title={`Patients : ${currentErp.patient.firstName}`}>
        {/* <Descriptions.Item label={translate('Address')}>
          {currentErp.patient.address}
        </Descriptions.Item> */}
        <Descriptions.Item label={translate('email')}>{currentErp.patient.email}</Descriptions.Item>
        <Descriptions.Item label={translate('Phone')}>{currentErp.patient.phone}</Descriptions.Item>
      </Descriptions>
      <Divider />
      <Row gutter={[12, 0]}>
        <Col className="gutter-row" span={11}>
