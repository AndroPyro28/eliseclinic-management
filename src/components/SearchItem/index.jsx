    ...
    return displayLabels
      .map((label) => {
        if (typeof label === 'object') {
          const propsKey = label.dataIndex;
          const propsKeyProperty = label.indexProperty;
          let value = valueByString(optionField, propsKey, undefined, propsKeyProperty);
          return value;
        }
        return optionField[label];
      })
      .join('');
  };
